...
log2.cpm.df.pivot <- pivot_longer(log2.cpm.df, # dataframe to be pivoted
                                  cols = totalRNA_0hr_rep1:totalRNA_48hr_rep2, # column names to be stored as a SINGLE variable
...
profile(data = myDGEList, samples = sampleLabels)
profile(data = myDGEList.filtered, samples = sampleLabels)
profile(data = myDGEList.filtered.norm, samples = sampleLabels)
