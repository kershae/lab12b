...
#Can also set capped = F which means it won't cap Y-axis
...
c2cp <- read.gmt("/Users/annakersh/Desktop/CourseData/mappedReads/c2.cp.v7.4.symbols.gmt")
...
broadSet.C2.ALL <- getGmt("/Users/annakersh/Desktop/CourseData/mappedReads/c2.cp.v7.4.symbols.gmt", geneIdType=SymbolIdentifier())
#extract as a list
